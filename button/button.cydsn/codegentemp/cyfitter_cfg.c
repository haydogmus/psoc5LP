...
#define CY_CFG_BASE_ADDR_COUNT 1
typedef struct
{
	uint8 offset;
	uint8 value;
...
#define cy_cfg_data_table ((const cy_cfg_addrvalue_t CYFAR *)0x48000004)

/* IOPINS0_8 Address: CYREG_PRT15_DR Size (bytes): 10 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000008)

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000014)

/* IOPINS0_6 Address: CYREG_PRT6_DR Size (bytes): 10 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x4800001C)
