...
#define CY_CFG_BASE_ADDR_COUNT 13
typedef struct
{
	uint8 offset;
	uint8 value;
...
#define cy_cfg_data_table ((const cy_cfg_addrvalue_t CYFAR *)0x48000034)

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000064)

/* IOPINS0_6 Address: CYREG_PRT6_DM0 Size (bytes): 8 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x4800006C)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x48000074)
...
void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8(CYREG_PRT6_AG, 0x20);
